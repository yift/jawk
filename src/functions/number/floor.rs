...
pub fn get() -> FunctionDefinitions {
    FunctionDefinitions::new("floor", 1, 1, |args| {
    ...
    .add_description_line("If the argument is numeric, return it's floor.")
    ...
    .add_example(Example::new().add_argument("-10.5").expected_output("-11"))
    .add_example(Example::new().add_argument("10.99").expected_output("10"))
